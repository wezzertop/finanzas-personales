...
function Sidebar({ currentPage, navigateTo, closeMobileMenu, userEmail, session }) {
  ...
  return (
    // Contenedor principal: flex-col y h-full
    <aside className="w-full h-full bg-gray-900 text-gray-300 flex flex-col shadow-lg">
      {/* Header: Fijo arriba, no se encoge */}
      <div className="flex justify-between items-center p-4 flex-shrink-0 border-b border-gray-700/50"> {/* Borde inferior sutil */}
      ...
      {/* flex-grow para que ocupe el espacio restante, overflow-y-auto para el scroll */}
      <div className="flex-grow overflow-y-auto p-2"> {/* Padding aplicado aquí */}
